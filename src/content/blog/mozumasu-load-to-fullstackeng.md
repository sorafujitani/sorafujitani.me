...
よく参照される [roadmap.sh の Full Stack ロードマップ](https://roadmap.sh/full-stack) もほぼこの構成で描かれている。ノードの数が多いが、全部やる必要はない。最初にやるべきものだけを以下のフェーズで示す。
...
- [roadmap.sh Backend](https://roadmap.sh/backend) — バックエンド領域の全体像。繰り返すが、全部やるためのものではなく確認用
...
| [roadmap.sh](https://roadmap.sh/full-stack) | 領域ごとの全体像の確認用 |
